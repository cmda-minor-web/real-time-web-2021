...
**Day assignment:** [(assignment)](./course/week-1.md) Make it so *(as a team)*: Implement (code/style/discuss/deploy) basic chat (or other realtime) functionality on your teampage!
